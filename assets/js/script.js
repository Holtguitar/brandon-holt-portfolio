...
const skillsetLink = document.getElementById("nav-skillset");
const portfolioLink = document.getElementById("nav-portfolio");
const contactLink = document.getElementById("nav-contact");
const navRefs = [home, about, skillset, portfolio, contact];
const navLinks = [
  homeLink,
  aboutLink,
  skillsetLink,
...
window.addEventListener("scroll", function () {
  ...
  if (scroll >= home.offsetTop && scroll < about.offsetTop) {
    // console.log(scroll - extraOffSet);
    removeActive();
    homeLink.classList.add("active-link");
  } else if (scroll >= about.offsetTop && scroll <= skillset.offsetTop) {
    removeActive();
    aboutLink.classList.add("active-link");
  } else if (scroll >= skillset.offsetTop && scroll <= portfolio.offsetTop) {
    removeActive();
    skillsetLink.classList.add("active-link");
